(function () {
    // 从环境变量中获取 VOICE_API_URLS
    const apiUrls = [
        "https://voiceapi.firefly.oy.lc",  // Stub for local testing
        // Please replace this part with the actual environment variable setup in Cloudflare Pages
    ];
